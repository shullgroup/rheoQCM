...
qcm.prop_plot_from_csv(propfig, base_fig_name2 + '_13.txt', 'rv', legend2text)
...
# add the data to the texts
qcm.prop_plot_from_csv(propfig, base_fig_name1 + '_355.txt', 'b+', 'DGEBA-Jeffamine230 355 (1:1)')
qcm.prop_plot_from_csv(propfig, base_fig_name1 + '_133.txt', 'bx', 'DGEBA-Jeffamine230 133 (1:1)')
...
propfig['grho_ax'].set_xscale('log')
propfig['phi_ax'].set_xscale('log')
qcm.vgp_plot_from_csv(vgpfig, base_fig_name1 + '_355.txt', 'b+', 'DGEBA-Jeffamine230 355 (1:1)')
qcm.vgp_plot_from_csv(vgpfig, base_fig_name1 + '_133.txt', 'bx', 'DGEBA-Jeffamine230 133 (1:1)')
qcm.vgp_plot_from_csv(vgpfig, base_fig_name2 + '_355.txt', 'bo', 'DGEBA-Jeffamine230 355 (2:1)')
qcm.vgp_plot_from_csv(vgpfig, base_fig_name2 + '_3133.txt', 'bv', 'DGEBA-Jeffamine230 133 (2:1)')
