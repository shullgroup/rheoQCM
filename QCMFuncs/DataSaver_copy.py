'''
This module is a copy of DataSaver in modules folder to make is easy to include it with QCM_functions
...
class DataSaver:
    def __init__(self, ver='', settings_init={'max_harmonic': 9, 'time_str_format': '%Y-%m-%d %H:%M:%S.%f'}):
        '''
