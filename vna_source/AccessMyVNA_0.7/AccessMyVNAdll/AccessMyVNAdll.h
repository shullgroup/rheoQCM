...
int MyVNAGetHelper( TCHAR * pString, enum VARENUM, void *pnResult );
...
int MyVNASetIntArrayHelper( TCHAR * pString, int nWhat, int nIndex, int nArraySize, int *pnResult );
int MyVNAGetDoubleArrayHelper( TCHAR * pString, int nWhat, int nIndex, int nArraySize, double *pnResult );
int MyVNASetDoubleArrayHelper( TCHAR * pString, int nWhat, int nIndex, int nArraySize, double *pnResult );
int MyVNASetStringHelper( TCHAR * pString, int nWhat, int nIndex, TCHAR * sWhat );
CString MyVNAGetStringHelper( TCHAR * sWhat, int nWhat, int nIndex );
...
__declspec(dllexport) int _stdcall MyVNASetString(int nWhat, int nIndex, TCHAR * sWhat );
