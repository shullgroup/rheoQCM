...
int MyVNAGetHelper(TCHAR * pString, enum VARENUM type, void *pnResult)
{
...
int MyVNASetHelperInt(TCHAR * pString, enum VARENUM type, int Value)
{
...
int MyVNASetHelperDouble(TCHAR * pString, enum VARENUM type, double Value)
{
...
int MyVNACallFunctionVoid(TCHAR * pString)
{
...
int MyVNACallFunctionBstr(TCHAR * pStrFunction, TCHAR * pStrParameter)
{
...
int MyVNAGetIntArrayHelper(TCHAR * pString, int nWhat, int nIndex, int nArraySize, int *pnResult)
{
...
int MyVNASetIntArrayHelper(TCHAR * pString, int nWhat, int nIndex, int nArraySize, int *pnData)
{
...
int MyVNAGetDoubleArrayHelper(TCHAR * pString, int nWhat, int nIndex, int nArraySize, double *pnResult)
{
...
int MyVNASetDoubleArrayHelper(TCHAR * pString, int nWhat, int nIndex, int nArraySize, double *pnData)
{
...
// helper function to set an array of double data
int MyVNASetStringHelper(TCHAR * pString, int nWhat, int nIndex, TCHAR * sWhat)
{
...
CString MyVNAGetStringHelper(TCHAR * pString, int nWhat, int nIndex)
{
...
// /////////////////////////////////////////////////////////////////////////////////////////////////
// get and set miscellaneous double array based data
__declspec(dllexport) int _stdcall MyVNASetString(int nWhat, int nIndex, TCHAR * sValue)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
__declspec(dllexport) int _stdcall MyVNALoadConfiguration(TCHAR * fileName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return MyVNACallFunctionBstr(_T("LoadConfiguration"), fileName);
}

__declspec(dllexport) int _stdcall MyVNASaveConfiguration(TCHAR * fileName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return MyVNACallFunctionBstr(_T("SaveConfiguration"), fileName);
}

__declspec(dllexport) int _stdcall MyVNALoadCalibration(TCHAR * fileName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return MyVNACallFunctionBstr(_T("LoadCalibration"), fileName);
}

__declspec(dllexport) int _stdcall MyVNASaveCalibration(TCHAR * fileName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return MyVNACallFunctionBstr(_T("SaveCalibration"), fileName);
}

__declspec(dllexport) int _stdcall MyVNASaveTraceData(TCHAR * fileName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
...
__declspec(dllexport) int _stdcall MyVNASetEqCctLogFile(TCHAR * fileName)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	return MyVNACallFunctionBstr(_T("SetEqCctLogFile"), fileName);
}

__declspec(dllexport) int _stdcall MyVNALogEqCctResults(TCHAR * description)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
